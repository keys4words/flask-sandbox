...
class ConfigClass(object):
    ...
    # Flask settings
    SECRET_KEY = 'something ultemately secret and more secure than you can expect'

    # Flask-SQLAlchemy settings
    basedir = os.path.abspath(os.path.dirname(__file__))
    SQLALCHEMY_DATABASE_URI = 'sqlite:///' + os.path.join(basedir, 'basic_app.sqlite')
    ...
    MAIL_PORT = 465
    MAIL_USE_SSL = True
    MAIL_USERNAME = 'novmet.info@gmail.com'
    MAIL_PASSWORD = 'mziJ6t1jDCIvD9MR1YpU'
